                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">View Shipping</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="category" class="table table-bordered table-striped">
                                    ...
                                    @foreach($shipping_charges as $shipping)
                                        <tr>
                                            ...
                                            <td>{{$shipping->shipping_charges2001_3000g}}</td>
                                            <td>{{$shipping->updated_at}}</td>

                                            <td>
                                                <a title="Edit Category" href="{{url('admin/edit-shipping/'. $shipping->id)}}" class="btn btn-success"><i class="fas fa-edit"></i></a>&nbsp;
